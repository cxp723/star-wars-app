...
export const isFetchingPlanetsSelector = (state) =>
  state.planetsPage.isFetchingPlanets;
export const isFetchingPlanetsInfoSelector = (state) =>
  state.planetsPage.isFetchingPlanetsInfo;
export const pageSizeSelector = (state) => state.planetsPage.pageSize;
export const planetsTotalCountSelector = (state) =>
  state.planetsPage.planetsTotalCount;
